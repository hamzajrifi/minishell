...
/*   Updated: 2022/06/26 01:03:46 by otmallah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	normm(t_list *list, t_shell *mini, int *fd, int i)
{
	...
	if (list && ft_strcmp(list->val[0], "exit") == 0 && list->val[1])
		...
		&& ((ft_strcmp(list->val[0], "cat") == 0 && !list->val[1] && list->val[1][0] != '-') 
			|| (ft_strcmp(list->val[0], "wc") == 0 && !list->val[1] && list->val[1][0] != '-')
			|| (ft_strcmp(list->val[0], "grep") == 0 && !list->val[1] && list->val[1][0] != '-')
			|| (ft_strcmp(list->val[0], "more") == 0)) && !list->val[1] && list->val[1][0] != '-')
	{
		mini->cnt = 2;
	}
